...
export class EditMovieDetailsComponent implements OnInit {
 ...
 constructor (private movieservice:MovieService){
  ...
  ngOnInit(): void {
   ...
   {
this.editMovie=res;
this.selectedReleaseDate=`${this.editMovie.releaseDate.year}-${this.leadingZero(this.editMovie.releaseDate.month,2)}-${this.leadingZero(this.editMovie.releaseDate.day,2)}`;
  ...
  { 
    ...
    formData.append("ReleaseDate.Day", this.editMovie.releaseDate.day.toString()); 
    formData.append("ReleaseDate.Month", this.editMovie.releaseDate.month.toString()); 
    formData.append("ReleaseDate.Year", this.editMovie.releaseDate.year.toString()); 
